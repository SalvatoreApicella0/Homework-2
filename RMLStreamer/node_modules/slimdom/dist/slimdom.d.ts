 ...
 * @public
 */
export declare type ParseOptions = Partial<{
    /**
 ...
 */
export declare function parseXmlDocument(input: string, options?: ParseOptions): Document;
 ...
 */
export declare function parseXmlFragment(input: string, options?: Partial<{
    /**
