...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < round; i++) {
            try {
                ...
                System.out.println("TEMPO DI ESECUZIONE dell'iterazione " + i + " : " + executionTime + " s");
        ...
        System.out.println("\n");
        System.out.println("Operazioni di READ: " + readOP/round);
        System.out.println("Operazioni di WRITE: " + writeOP/round);
        System.out.println("\n");
        calculateMetrics(executionTimes);
    }
    ...
    public static void calculateMetrics(List<Long> executionTimes) {
        // Calcola il tempo più veloce
        long fastestTime = Collections.min(executionTimes);
        
        // Calcola il tempo più lento
        long slowestTime = Collections.max(executionTimes);

        // Calcola il tempo medio
        double meanTime = executionTimes.stream().mapToLong(Long::longValue).average().orElse(0.0);

        // Ordina i tempi per il calcolo dei quartili
        Collections.sort(executionTimes);
        
        // Calcola il primo quartile (Q1)
        double q1 = getPercentile(executionTimes, 25);

        // Calcola il secondo quartile (Q2 o mediana)
        double q2 = getPercentile(executionTimes, 50);

        // Calcola il terzo quartile (Q3)
        double q3 = getPercentile(executionTimes, 75);

        // Stampa le metriche
        System.out.println("METRICS:");
        System.out.println("Fastest Round Execution Time: " + fastestTime + " s");
        System.out.println("Slowest Round Execution Time: " + slowestTime + " s");
        System.out.println("Mean Round Execution Time: " + meanTime + " s");
        System.out.println("Q1 of Round Execution Times: " + q1 + " s");
        System.out.println("Q2 (Median) of Round Execution Times: " + q2 + " s");
        System.out.println("Q3 of Round Execution Times: " + q3 + " s");

    }

    private static double getPercentile(List<Long> sortedList, double percentile) {
    ...
    public static void run(String[] args, String basePath) throws Exception {
        ...
        try {
            ...
            if (lineArgs.hasOption("c")) {
                ...
                System.out.println("Leggo il config file");
            ...
            // Read mapping file.
            System.out.println("Leggo il mapping");
